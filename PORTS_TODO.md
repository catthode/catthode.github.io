...
- [ ] **Ghostty bundled theme**
  - [x] Publish the exact Ghostty artifact generated by `mbadolato/iTerm2-Color-Schemes#741` in a dedicated `catthode/ghostty` repository.
  ...
  - [ ] Monitor the open, mergeable upstream contribution until it is accepted into the bundled theme source.
